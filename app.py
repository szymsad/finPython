...
from tabs import macd_analysis, ikze_calc, dca_strat, fundamental
...
# setup_sidebar Tab 1 musi być wywołany PRZED st.tabs(),
# bo Streamlit wymaga żeby widgety sidebar były tworzone przed elementami głównej strony
params = macd_analysis.setup_sidebar(params)
params = dca_strat.setup_sidebar(params)
